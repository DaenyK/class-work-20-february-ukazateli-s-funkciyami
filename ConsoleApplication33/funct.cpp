...
//6.	«Быстрая» сортировка (разделением) с использованием указателей на правую и левую границы массива, текущих указателей на правый 
//и левый элемент и операции сравнения указателей 
